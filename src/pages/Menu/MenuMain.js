            ...
            <div className="burgers-container">
              ...
              <div className="burgers">
                <div className="burger">
                  ...
                  />
                  <label className="label" htmlFor="burger">
                    Carne
                  </label>
                </div>
                <div className="burger">
                  ...
                  <input
                    ...
                    onChange={handleChange}
                  />
                  <label className="label" htmlFor="chicken-burger">
                    Frango
                  </label>
                </div>
                <div className="burger">
                  ...
                  <input
                    ...
                    onChange={handleChange}
                  />
                  <label className="label" htmlFor="vegan-burger">
                    Vegetariano
                  </label>
                </div>
              </div>
                  ...
                  <div className="options">
                    <div className="extra">
                      <input
                        ...
                        onChange={handleChange}
                      />
                      <label className="label extra-items" htmlFor="simple">
                        Simples
                      </label>
                    </div>
                    <div className="extra">
                      <input
                        ...
                        onChange={handleChange}
                      />
                      <label className="label extra-items" htmlFor="double">
                        Duplo
                      </label>
                    </div>
                  </div>
                  ...
                  <div className="extra-options">
                    <div className="extra">
                      <input
                        ...
                        onChange={handleChange}
                      />
                      <label className="label extra-items" htmlFor="cheese">
                        Queijo
                      </label>
                    </div>
                    <div className="extra">
                      <input
                        ...
                        onChange={handleChange}
                      />
                      <label className="label extra-items" htmlFor="egg">
                        Ovo
                      </label>
                    </div>
                    <div className="extra">
                      <input
                        ...
                        onChange={handleChange}
                      />
                      <label className="label extra-items" htmlFor="none">
                        Nenhum
                      </label>
                    </div>
                  </div>
            ...
            <div className="sidedishes-container">
              ...
              <div className="sidedishes">
                <div className="sidedishe">
                  ...
                  />
                  <label className="label" htmlFor="fries">
                    Fritas
                  </label>
                </div>
                <div className="sidedishe">
                  ...
                  <input
                    ...
                    onChange={filterByItemName}
                  />
                  <label className="label" htmlFor="onion-rings">
                    Anéis de cebola
                  </label>
                </div>
              </div>
